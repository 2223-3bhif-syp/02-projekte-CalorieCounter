...
CREATE TABLE CC_CONSUMPTION (
    ...
    C_U_ID                  INTEGER NOT NULL CONSTRAINT C_U_FK REFERENCES CC_USER(U_ID) ON DELETE CASCADE,
    C_F_ID                  INTEGER NOT NULL CONSTRAINT F_FK REFERENCES CC_FOOD(F_ID) ON DELETE CASCADE,
    C_AMOUNT                INTEGER
);